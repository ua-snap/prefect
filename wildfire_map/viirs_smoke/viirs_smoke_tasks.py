...
@task(name="Install VIIRS Smoke Conda Environment")
...
@task(name="Execute VIIRS Smoke Script")
def execute_local_script(script_path, output_path, conda_env_name="viirs_smoke"):
