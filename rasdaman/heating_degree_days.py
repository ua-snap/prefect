...
if __name__ == "__main__":
    heating_degree_days.serve(
        ...
        parameters={
            ...
            "ingest_directory": "/opt/rasdaman/user_data/rltorgerson/rasdaman-ingest/arctic_eds/degree_days/heating_degree_days/",
            "source_directory": "/workspace/Shared/Tech_Projects/Arctic_EDS/project_data/rasdaman_datasets/heating_degree_days/",
            "destination_directory": "/opt/rasdaman/user_data/rltorgerson/rasdaman-ingest/arctic_eds/degree_days/heating_degree_days/geotiffs/",
        },
    )
