...
if __name__ == "__main__":
    jul_min_mean_max_temp.serve(
        ...
        parameters={
            ...
            "ingest_directory": "/opt/rasdaman/user_data/rltorgerson/rasdaman-ingest/arctic_eds/jan_july_tas_stats/jul_min_mean_max_tas/",
            "source_directory": "/workspace/Shared/Tech_Projects/Arctic_EDS/project_data/rasdaman_datasets/jul_min_max_mean_temp/",
            "destination_directory": "/opt/rasdaman/user_data/rltorgerson/rasdaman-ingest/arctic_eds/jan_july_tas_stats/jul_min_mean_max_tas/geotiffs/",
        },
    )
