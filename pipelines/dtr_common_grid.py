...
Works on CMIP6 data that has been regridded to a common grid, mainly so that all
models/scenarios are in a common directory structure of <model>/<scenario>/<variable>.
"""
