...
if __name__ == "__main__":
    thawing_index.serve(
        ...
        parameters={
            ...
            "ingest_directory": "/opt/rasdaman/user_data/rltorgerson/rasdaman-ingest/arctic_eds/degree_days/thawing_index/",
            "source_directory": "/workspace/Shared/Tech_Projects/Arctic_EDS/project_data/rasdaman_datasets/thawing_index/",
            "destination_directory": "/opt/rasdaman/user_data/rltorgerson/rasdaman-ingest/arctic_eds/degree_days/thawing_index/geotiffs/",
        },
    )
