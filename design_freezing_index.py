...
if __name__ == "__main__":
    design_freezing_index.serve(
        ...
        parameters={
            ...
            "ingest_directory": "/opt/rasdaman/user_data/rltorgerson/rasdaman-ingest/arctic_eds/design_indices/design_freezing_index/",
            "source_directory": "/workspace/Shared/Tech_Projects/Arctic_EDS/project_data/rasdaman_datasets/design_freezing_index/",
            "destination_directory": "/opt/rasdaman/user_data/rltorgerson/rasdaman-ingest/arctic_eds/design_indices/design_freezing_index/geotiffs/",
        },
    )
